...
{
    public class When_opening_an_existing_account : PresenterTestFixture<ClientDetailsPresenter>
    {
    ...
    public class When_displaying_account_details : PresenterTestFixture<AccountDetailsPresenter>
    {
