...
namespace Test.Fohjin.DDD.Reporting.Infrastructure
{
    ...
    public class SqlInsertBuilderTest
    {
        ...
        {
            Assert.AreEqual(_sqlInsertBuilder.CreateSqlInsertStatementFromDto<TestDtoCase1>(),
        ...
        {
            Assert.AreEqual(_sqlInsertBuilder.CreateSqlInsertStatementFromDto<TestDtoCase4>(),
